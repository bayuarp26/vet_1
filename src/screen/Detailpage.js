                    ...
                    <View style={styles.daerah}>
                        ...
                        <View style={styles.waktu}>
                            ...
                            <TouchableOpacity>
                                ...
                                <Icon name='md-add-circle' size={20} color='#0000000' style={{paddingHorizontal:5,}} />
                                <Text style={{color:'#000000', fontSize:14,}} onPress={() => navigation.navigate('TambahHewanScreen')}>
                                    Tambahkan Hewan
                                </Text>
                                </View>
                            </TouchableOpacity>
